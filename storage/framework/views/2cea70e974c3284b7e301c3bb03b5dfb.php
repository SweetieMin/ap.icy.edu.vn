        ...
        <div class="theme-table-pink">
            ...
            <div class="hidden md:block overflow-x-auto max-h-[calc(100vh-300px)]">
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $tuitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tuition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php endif; ?>
                                ...
                                <td class="text-center hidden sm:table-cell">
                                    <?php switch($tuition->payment_method):
                                        case ('cash'): ?>
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <?php if($tuition->program->english_name): ?>
