...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'name','label' => '👨‍🎓 Họ và tên 🚩','placeholder' => 'Nhập họ và tên đầy đủ','wire:change' => 'updateUsername','class' => 'rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 transition-all duration-300','autofocus' => true,'disabled' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
