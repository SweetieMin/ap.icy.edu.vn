...
<?php endif; ?>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                ...
                <button wire:click="addSubject" class="header-button w-full sm:w-auto">
                        ...
                        <div class="bg-pink-100 dark:bg-zinc-800 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-pink-600 dark:text-white text-xs"><?php echo e($programs->count()); ?> chương trình</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4">
                                        ...
                                        <button wire:click="selectProgram(<?php echo e($program->id); ?>)"
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div class="w-8 h-8 rounded-lg flex items-center justify-center <?php echo e((int) $selectedProgramId === (int) $program->id ? 'bg-pink-100 dark:bg-pink-800/30' : 'bg-zinc-200 dark:bg-zinc-700'); ?>">
                                                    <svg class="w-4 h-4 <?php echo e((int) $selectedProgramId === (int) $program->id ? 'text-pink-600 dark:text-white' : 'text-zinc-600 dark:text-zinc-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 bg-pink-200 dark:bg-white rounded-xl flex items-center justify-center">
                                                <span class="text-pink-600 dark:text-black font-bold text-lg"><?php echo e($subject->ordering); ?></span>
                                            </div>
                                            <div>
