...
<?php endif; ?>
            ...
            <div class="flex items-center space-x-3">
                <div class="header-counter">
                    <span><?php echo e($subjects->total() ?? 0); ?> môn học</span>
                </div>
...
[$__name, $__params] = $__split('back.management.subject.actions-subject', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3253556094-0', $__slots ?? [], get_defined_vars());
    ...
    <div class="mt-6">
        ...
        @program-changed.window="destroySortable(); setTimeout(() => initSortable(), 100)">
            <div class="flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="bg-pink-100 dark:bg-zinc-800 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-pink-600 dark:text-pink-400 text-xs"><?php echo e($programs->count()); ?> chương trình</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div wire:key="program-<?php echo e($program->id); ?>" class="group">
                                        <button wire:click="selectProgram(<?php echo e($program->id); ?>)"
                                            class="w-full text-left px-4 py-3 rounded-xl text-sm transition-all duration-300 transform hover:scale-[1.02] <?php echo e((int) $selectedProgramId === (int) $program->id ? 'bg-pink-50 dark:bg-pink-900/20 text-pink-600 dark:text-pink-400 border border-pink-200 dark:border-pink-800 shadow-lg' : 'text-zinc-600 dark:text-zinc-400 hover:text-pink-600 dark:hover:text-pink-400 hover:bg-pink-100 dark:hover:bg-zinc-800 border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700'); ?>">
                                            <div class="flex items-center space-x-3">
                                                <div class="w-8 h-8 rounded-lg flex items-center justify-center <?php echo e((int) $selectedProgramId === (int) $program->id ? 'bg-pink-100 dark:bg-pink-800/30' : 'bg-zinc-200 dark:bg-zinc-700'); ?>">
                                                    <svg class="w-4 h-4 <?php echo e((int) $selectedProgramId === (int) $program->id ? 'text-pink-600 dark:text-pink-400' : 'text-zinc-600 dark:text-zinc-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex-1 min-w-0" wire:key="subjects-content-<?php echo e($selectedProgramId); ?>">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 bg-pink-200 dark:bg-pink-800/30 rounded-xl flex items-center justify-center">
                                                <span class="text-pink-600 dark:text-pink-400 font-bold text-lg"><?php echo e($subject->ordering); ?></span>
                                            </div>
                                            <div>
                                                <h3 class="text-lg font-bold text-pink-600 dark:text-pink-400 truncate"><?php echo e($subject->name); ?></h3>
                                                <!--[if BLOCK]><![endif]--><?php if($subject->code): ?>
                                                    <p class="text-pink-600 dark:text-pink-400 text-sm"><?php echo e($subject->code); ?></p>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        </div>
...
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/livewire/back/management/subject/subjects.blade.php ENDPATH**/ ?>