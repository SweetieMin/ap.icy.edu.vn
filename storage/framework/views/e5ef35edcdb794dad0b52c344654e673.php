...
<head>
    ...
    <meta property="og:title" content="NGOẠI NGỮ SÁNG TẠO QUỐC TẾ - <?php echo e(config('app.name')); ?>">
    <meta property="og:description"
        content="Nền tảng quản lý học viên, khóa học và lịch học trực tuyến dành riêng cho các trung tâm tiếng Anh ICY">
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:site_name" content="NGOẠI NGỮ SÁNG TẠO QUỐC TẾ - <?php echo e(config('app.name')); ?>">
    ...
    <meta name="twitter:title" content="NGOẠI NGỮ SÁNG TẠO QUỐC TẾ - <?php echo e(config('app.name')); ?>">
...
<body class="bg-white text-slate-800">
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-10">
        ...
        <div class="mt-6 md:mt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
            <span class="text-slate-500 text-xs md:text-sm">© <?php echo e(date('Y')); ?> ICY English. All rights
                reserved.</span>
