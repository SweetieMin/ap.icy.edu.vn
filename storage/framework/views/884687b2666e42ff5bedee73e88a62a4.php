...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-header','data' => ['title' => __('Quên mật khẩu'),'description' => __('Nhập email của bạn để nhận liên kết đặt lại mật khẩu')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Quên mật khẩu')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Nhập email của bạn để nhận liên kết đặt lại mật khẩu'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model' => 'email','label' => __('Địa chỉ Email'),'type' => 'email','required' => true,'placeholder' => 'email@example.com','autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'email','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Địa chỉ Email')),'type' => 'email','required' => true,'placeholder' => 'email@example.com','autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','type' => 'submit','class' => 'w-full']); ?><?php echo e(__('Gửi liên kết đặt lại mật khẩu')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-400">
        <span><?php echo e(__('Hoặc, quay lại')); ?></span>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('login')),'wire:navigate' => true]); ?><?php echo e(__('Đăng nhập')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/livewire/auth/forgot-password.blade.php ENDPATH**/ ?>