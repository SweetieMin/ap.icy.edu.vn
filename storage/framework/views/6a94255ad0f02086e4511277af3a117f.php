...
<?php $__env->startSection('error-code'); ?>
    404
...
<?php $__env->startSection('error-description'); ?>
...
<?php $__env->startSection('error-image'); ?>
    <div class="relative">
        <img src="<?php echo e(asset('storage/images/sites/404.png')); ?>" 
             alt="404 Not Found" 
...
<?php $__env->startSection('error-additional'); ?>
    <div class="space-y-4">
        ...
        <div class="flex items-start space-x-3">
            ...
            <div>
                ...
                <div class="mt-2 flex flex-wrap gap-2">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-sm text-pink-600 dark:text-pink-400 hover:underline">Bảng điều khiển</a>
                    <span class="text-gray-400">•</span>
                    <a href="<?php echo e(route('admin.management.locations')); ?>" class="text-sm text-pink-600 dark:text-pink-400 hover:underline">Cơ sở</a>
                    <span class="text-gray-400">•</span>
                    <a href="<?php echo e(route('admin.management.programs')); ?>" class="text-sm text-pink-600 dark:text-pink-400 hover:underline">Chương trình học</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('components.layouts.error', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/errors/404.blade.php ENDPATH**/ ?>