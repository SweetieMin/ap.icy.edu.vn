...
<body>
    ...
    <img src="<?php echo e(public_path('/favicon.svg')); ?>" class="logo" alt="Logo ICY">
    ...
    <div class="section">
        <div class="section-title">1) THÔNG TIN HỌC VIÊN - <?php echo e($student->account_code); ?></div>
        <div class="field">Họ và tên: <span class="input-line" style="width: 50%;"><?php echo e($student->name); ?></span>username:
            <span class="input-line" style="width: 25%;"><?php echo e($student->username); ?></span>
        </div>
        <div class="field">
            Ngày sinh:
            <span class="date-input"><?php echo e($student->detail->birthday_day); ?></span> /
            <span class="date-input"><?php echo e($student->detail->birthday_month); ?></span> /
            <span class="date-input"><?php echo e($student->detail->birthday_year); ?></span>

            &nbsp;&nbsp; Giới tính:
            <span class="checkbox">
                <?php if(!$student->detail->gender): ?>
        ...
        <div class="field">Số điện thoại: <span class="input-line"
                style="width: 30%;"><?php echo e($student->detail->phone); ?></span> &nbsp;&nbsp; Email:
            <span class="input-line" style="width: 35%;"><?php echo e($student->email); ?></span>
        </div>
        <div class="field">Địa chỉ: <span class="input-line" style="width: 80%;"><?php echo e($student->detail->address); ?></span>
        </div>
    ...
    <div class="section">
        ...
        <div class="field">Họ tên <span class="input-line"
                style="width: 50%;"><?php echo e($student->detail->guardian_name); ?></span> SĐT: <span class="input-line"
                style="width: 25%;"><?php echo e($student->detail->guardian_phone); ?></span></div>
    ...
    <div class="section">
        ...
        <div>Lúc: <span class="time-input"><?php echo e(now()->format('H:i')); ?></span> Ngày <span
                class="date-input"><?php echo e(now()->format('d')); ?></span>/<span
                class="date-input"><?php echo e(now()->format('m')); ?></span>/<span class="date-input"
                style="margin-right: 3mm;"><?php echo e(now()->format('Y')); ?></span> tại Trung tâm Ngoại ngữ Sáng Tạo Quốc Tế ICY
        </div>
    ...
    <div class="section">
        <div class="signature-container" style="margin-top: 10mm; text-align: center;">
            <div class="signature-section">
                <div class="signature-title"><?php echo e($student->detail->guardian_name); ?></div>
            </div>

            <div class="signature-section">
                <div class="signature-title"><?php echo e($student->name); ?></div>
            </div>

            <div class="signature-section">
                <div class="signature-title"><?php echo e($receptionist); ?></div>
            </div>
        </div>
    </div>
    <script>
...
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/pdf/student-registration.blade.php ENDPATH**/ ?>