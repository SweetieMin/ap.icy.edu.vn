...
$classes = Flux::classes()
    ...
    ->add('rounded-full transition-colors')
    ->add('bg-zinc-800/15 dark:bg-transparent dark:border dark:border-white/20')
    ->add('disabled:opacity-50 disabled:pointer-events-none dark:[&[disabled]]:border-white/10')
...
$indicatorClasses = Flux::classes()
    ->add('size-3.5')
    ->add('rounded-full transition-transform duration-200 ease-in-out translate-x-[3px] bg-white')
    ->add([
...
<?php $component->withAttributes(['attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes)]); ?>
        <ui-switch 
            ...
            data-flux-control data-flux-switch
            <?php if($attributes->has('disabled')): echo 'disabled'; endif; ?>
        >
...
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/vendor/livewire/flux/src/../stubs/resources/views/flux/switch.blade.php ENDPATH**/ ?>