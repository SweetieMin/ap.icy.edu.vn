...
<?php $component->withAttributes(['attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($name)]); ?>
    <ui-date-picker
        ...
        <?php if(isset($unavailable) && $unavailable !== ''): ?> unavailable="<?php echo e($unavailable); ?>" <?php endif; ?>
        <?php if($showName): ?> name="<?php echo e($name); ?>" <?php endif; ?>
        <?php if(isset($value)): ?> value="<?php echo e($value); ?>" <?php endif; ?>
    >
        <?php if ($trigger === null): ?>
            <?php if ($type === 'input'): ?>
            <?php if (isset($component)) { $__componentOriginal31c3736bb0c0e25b0cdbc57b45255d6c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal31c3736bb0c0e25b0cdbc57b45255d6c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::date-picker.input','data' => ['placeholder' => $placeholder,'invalid' => $invalid,'size' => $size,'clearable' => $clearable]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::date-picker.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal31c3736bb0c0e25b0cdbc57b45255d6c)): ?>
<?php $attributes = $__attributesOriginal31c3736bb0c0e25b0cdbc57b45255d6c; ?>
<?php unset($__attributesOriginal31c3736bb0c0e25b0cdbc57b45255d6c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal31c3736bb0c0e25b0cdbc57b45255d6c)): ?>
<?php $component = $__componentOriginal31c3736bb0c0e25b0cdbc57b45255d6c; ?>
<?php unset($__componentOriginal31c3736bb0c0e25b0cdbc57b45255d6c); ?>
<?php endif; ?>
            <?php else: ?>
                    ...
                    <ui-calendar-inputs class="flex items-center p-2 border-b border-zinc-200 dark:border-white/10">
                        <?php if ($range): ?>
                            <div class="sm:px-2 flex items-center gap-4">
                                <div class="flex items-center gap-2"><span class="max-sm:hidden text-sm font-medium text-zinc-800 dark:text-white"><?php echo e(__('Start')); ?></span> <?php if (isset($component)) { $__componentOriginal26c546557cdc09040c8dd00b2090afd0 = $component; } ?>
...
<?php endif; ?></div>
                                <div class="flex items-center gap-2"><span class="max-sm:hidden text-sm font-medium text-zinc-800 dark:text-white"><?php echo e(__('End')); ?></span> <?php if (isset($component)) { $__componentOriginal26c546557cdc09040c8dd00b2090afd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal26c546557cdc09040c8dd00b2090afd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['type' => 'date','class' => 'w-[full] sm:w-[11.25rem]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::input'); ?>
<?php if ($component->shouldRender()): ?>
                ...
                <?php if ($presets): ?>
                    <ui-calendar-presets class="block sm:hidden px-4">
                        <select class="appearance-none w-full ps-3 pe-10 block h-10 py-2 text-sm rounded-lg shadow-2xs border bg-white dark:bg-white/10 dark:disabled:bg-white/[9%] text-zinc-700 dark:text-zinc-300 has-[option.placeholder:checked]:text-zinc-400 dark:has-[option.placeholder:checked]:text-zinc-400 disabled:shadow-none border border-zinc-200 border-b-zinc-300/80 dark:border-white/10" data-flux-control="" data-flux-select-native="" data-flux-group-target="">
                            <option value="" disabled="" selected="" class="placeholder"><?php echo e(__('Choose predefined range...')); ?></option>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $presetArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/vendor/livewire/flux-pro/src/../stubs/resources/views/flux/date-picker/index.blade.php ENDPATH**/ ?>