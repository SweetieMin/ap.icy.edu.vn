...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['wire:poll' => 'checkPaymentStatus()','name' => 'qr-bank-transfer','class' => 'max-w-4xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:poll' => 'checkPaymentStatus()','name' => 'qr-bank-transfer','class' => 'max-w-4xl']); ?>
        <div class="space-y-6">
            <!-- Header -->
            <div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.building-office','data' => ['class' => 'w-5 h-5 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'lg']); ?>Thông tin chuyển khoản <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-1']); ?>Quét QR hoặc chuyển khoản thủ công <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="text-center">
                                    <!--[if BLOCK]><![endif]--><?php if($crc16 && !empty($crc16)): ?>
                                        <?php echo \SimpleSoftwareIO\QrCode\Facades\QrCode::size(200)->encoding('UTF-8')->errorCorrection('M')->generate($crc16); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.qr-code','data' => ['class' => 'w-12 h-12 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.device-phone-mobile','data' => ['class' => 'w-4 h-4 text-green-600 mr-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-green-600 mr-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-3xl font-bold"><?php echo e(number_format($amount ?? 0, 0, ',', '.')); ?></p>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center mb-4">
                            <div
                                ...
                                <?php if (isset($component)) { $__componentOriginale95e70f8eaeac897e8c4dbb22322d565 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale95e70f8eaeac897e8c4dbb22322d565 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.building-office','data' => ['class' => 'w-4 h-4 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.building-office'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'base']); ?>Thông tin ngân hàng <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9)): ?>
<?php $attributes = $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9; ?>
<?php unset($__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9); ?>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <?php if (isset($component)) { $__componentOriginale95e70f8eaeac897e8c4dbb22322d565 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale95e70f8eaeac897e8c4dbb22322d565 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.building-office','data' => ['class' => 'w-4 h-4 text-blue-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.building-office'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                    ...
                                    <span
                                        class="text-sm font-bold text-gray-900"><?php echo e($bankName ?? 'Vietcombank'); ?></span>
                                </div>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.credit-card','data' => ['class' => 'w-4 h-4 text-green-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span
                                            class="text-sm font-bold text-gray-900 font-mono bg-gray-50 px-2 py-1 rounded"><?php echo e($accountNumber ?? '1234567890'); ?></span>
                                        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['variant' => 'ghost','size' => 'sm','icon' => 'clipboard-document','class' => 'opacity-0 group-hover:opacity-100 transition-opacity','onclick' => 'navigator.clipboard.writeText(\''.e($accountNumber ?? '1234567890').'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'ghost','size' => 'sm','icon' => 'clipboard-document','class' => 'opacity-0 group-hover:opacity-100 transition-opacity','onclick' => 'navigator.clipboard.writeText(\''.e($accountNumber ?? '1234567890').'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.user','data' => ['class' => 'w-4 h-4 text-purple-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.document-text','data' => ['class' => 'w-4 h-4 text-orange-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span
                                            class="text-sm font-bold text-gray-900 font-mono bg-gray-50 px-2 py-1 rounded"><?php echo e($contentTransaction ?? 'HOCPHI_2024_001'); ?></span>
                                        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['variant' => 'ghost','size' => 'sm','icon' => 'clipboard-document','class' => 'opacity-0 group-hover:opacity-100 transition-opacity','onclick' => 'navigator.clipboard.writeText(\''.e($contentTransaction ?? 'HOCPHI_2024_001').'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'ghost','size' => 'sm','icon' => 'clipboard-document','class' => 'opacity-0 group-hover:opacity-100 transition-opacity','onclick' => 'navigator.clipboard.writeText(\''.e($contentTransaction ?? 'HOCPHI_2024_001').'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
<?php $attributes = $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580; ?>
...
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/livewire/back/finance/tuition/q-r-bank-transfer.blade.php ENDPATH**/ ?>