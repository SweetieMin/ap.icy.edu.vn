                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td class="whitespace-nowrap text-center">
                                    <?php if($price): ?>
                                        <?php if(isset($editingPrices[$price['id']])): ?>
                                            
                                            <input type="number" 
                                                wire:model="editingPrices.<?php echo e($price['id']); ?>.price"
                                                class="price-input"
                                                placeholder="Nhập giá">
                                            <?php $__errorArgs = ["editingPrices.{$price['id']}.price"];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if($isEditingProgram): ?>
                                            
                                            <input type="number" 
                                                wire:model="newPrices.<?php echo e($program->id); ?>.<?php echo e($location->id); ?>"
                                                placeholder="Nhập giá"
                                                class="price-input">
                                            <?php $__errorArgs = ["newPrices.{$program->id}.{$location->id}"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
