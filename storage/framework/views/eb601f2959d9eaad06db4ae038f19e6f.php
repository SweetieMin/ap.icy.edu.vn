...
<?php endif; ?>
    ...
    <?php if($studentsWithoutLocation->count() > 0): ?>
            ...
            <div class="theme-table-pink">
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $studentsWithoutLocation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
