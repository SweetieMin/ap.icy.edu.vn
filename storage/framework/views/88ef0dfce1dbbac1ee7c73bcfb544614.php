...
<?php endif; ?>
                                                ...
                                                <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['color' => 'white','variant' => 'filled','size' => 'sm','icon' => 'google','wire:click.prevent' => 'linkGoogle','class' => 'bg-amber-600 hover:bg-amber-700 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'white','variant' => 'filled','size' => 'sm','icon' => 'google','wire:click.prevent' => 'linkGoogle','class' => 'bg-amber-600 hover:bg-amber-700 text-white']); ?>
                                                    Liên kết Google
                                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580)): ?>
...
<?php endif; ?>
                                            ...
                                            <?php if(session('status') === 'Tài khoản đã được liên kết thành công với Google!'): ?>
                                                <div
                                                    class="mt-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-700 rounded-lg">
                                                    <div class="flex items-center">
                                                        <svg class="w-5 h-5 text-emerald-600 dark:text-emerald-400 mr-3"
...
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/livewire/settings/profile.blade.php ENDPATH**/ ?>