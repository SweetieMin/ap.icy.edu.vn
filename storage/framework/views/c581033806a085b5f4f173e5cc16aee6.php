...
<?php endif; ?>
                                ...
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex flex-wrap gap-1 max-w-[200px] justify-end">
                                        <?php if($role->permissions->count() > 0): ?>
                                            <?php $__currentLoopData = $role->permissions->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span
