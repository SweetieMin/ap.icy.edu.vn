...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['wire:ignore.self' => true,'name' => 'view-event','class' => 'md:w-120']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:ignore.self' => true,'name' => 'view-event','class' => 'md:w-120']); ?>
    <div class="space-y-6">
        <div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'lg']); ?><?php echo e($eventName ?? ''); ?> <?php echo e($courseName ?? ''); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div
            class="rounded-2xl border border-gray-200 <?php echo e($eventColor ?? 'bg-white'); ?> p-5 shadow-sm dark:border-gray-800 dark:<?php echo e($eventColor ?? 'bg-stone-950'); ?>">
...
<?php $component->withAttributes(['variant' => 'ghost','class' => 'px-6 py-2 rounded-xl border border-gray-300 hover:bg-gray-50 transition-all duration-300']); ?>
                    Đóng <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
