...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('Bảng điều khiển')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Bảng điều khiển'))]); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-773264597-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/dashboard.blade.php ENDPATH**/ ?>