...
<div class="message">
    <p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn tại <strong><?php echo e($appName); ?></strong>.</p>
    
    <p>Để đặt lại mật khẩu mới, vui lòng nhấp vào nút bên dưới:</p>
</div>

<div style="text-align: center; margin: 30px 0;">
    <a href="<?php echo e($resetUrl); ?>" class="button" style='color: white;'>
        Đặt lại mật khẩu
    </a>
</div>
...
<div class="info-box">
    ...
    <ul style="margin: 10px 0; padding-left: 20px;">
        ...
        <li><strong>Thời gian yêu cầu:</strong> <?php echo e(now()->format('d/m/Y H:i:s')); ?></li>
    </ul>
</div>
...
<?php echo $__env->make('emails.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/smyth/Herd/ap.icy.edu.vn/resources/views/emails/reset-password.blade.php ENDPATH**/ ?>