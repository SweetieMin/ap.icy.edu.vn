    ...
    <div class="theme-card-pink mt-4 mb-4">
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                @endif
                <div class="flex flex-col justify-end items-end md:col-start-3">
                    <label class="card-label">Xuất danh sách</label>
                    <flux:button wire:click='exportDataStudent()' icon="arrow-down-tray" variant="primary">Export</flux:button>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tr wire:key="student-desktop-{{ $student->id }}">
                                    ...
                                    <td>
                                        <div class="flex items-center gap-3">
                                                <flux:avatar size="xl" circle src="{{ $student->detail?->avatar }}" alt="{{ $student->name }}"/>
                                            <div>
                                        ...
                                        <flux:dropdown>
                                            ...
                                            <flux:menu>
                                                <flux:menu.item icon="pencil"
                                                    wire:click="editStudent({{ $student->id }})">Sửa
                                                    thông tin
                                                </flux:menu.item>

                                                <flux:menu.item icon="circle-user-round"
                                                    wire:click="updateAvatar({{ $student->id }})">Cập nhật ảnh đại diện
                                                </flux:menu.item>
