                            ...
                            <tr wire:key="staff-desktop-{{ $staff->id }}">
                                ...
                                <td class="text-center">
                                    <flux:dropdown>
                                        ...
                                        <flux:menu>
                                            <flux:menu.item icon="pencil" wire:click="editStaff({{ $staff->id }})">
                                                Sửa thông tin
                                            </flux:menu.item>
                        ...
                        <div x-show="expanded" class="border-t border-gray-100 bg-gray-50">
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-sm text-gray-900">{{ $staff->detail?->phone ?? 'Chưa cập nhật' }}</span>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-sm text-gray-900">{{ $staff->roles->pluck('name')->implode(', ') ?: 'Chưa có chức vụ' }}</span>
                                </div>
