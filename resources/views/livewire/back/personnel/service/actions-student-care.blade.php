        ...
        <form wire:submit.prevent='createStudentCare' class="px-8 py-6 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group md:col-span-2">
                    <flux:textarea wire:model="parent_response" label="Phản hồi của phụ huynh" rows="4" placeholder="Nhập nội dung phản hồi (nếu có)" />

                </div>

                {{-- Ghi chú --}}
                <div class="form-group md:col-span-2">
                    <flux:textarea wire:model="note" label="Ghi chú thêm" rows="3" placeholder="Nhập ghi chú nội bộ (nếu cần)" />
                </div>
            </div>
